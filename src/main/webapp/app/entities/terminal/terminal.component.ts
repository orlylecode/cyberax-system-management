...
export class TerminalComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.terminalService
      ...
      .subscribe(
        (res: HttpResponse<ITerminal[]>) => this.paginateTerminals(res.body, res.headers),
  ...
  trackId(index: number, item: ITerminal) {
    return item.id;
  }
  ...
  protected paginateTerminals(data: ITerminal[], headers: HttpHeaders) {
