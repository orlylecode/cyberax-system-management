...
import { ListAttenteComponent } from 'app/entities/list-attente/list-attente.component';
...
describe('Component Tests', () => {
  describe('ListAttente Management Component', () => {
    let comp: ListAttenteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ListAttenteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.listAttentes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
