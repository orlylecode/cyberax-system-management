...
import { MiseComponent } from 'app/entities/mise/mise.component';
import { MiseService } from 'app/entities/mise/mise.service';
import { Mise } from 'app/shared/model/mise.model';

describe('Component Tests', () => {
  describe('Mise Management Component', () => {
    let comp: MiseComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MiseComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.mises[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
