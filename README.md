...
To build the final jar and optimize the cyberaxSystem application for production, run:
...
Then navigate to [http://localhost:6663](http://localhost:6663) in your browser.
